...
<?php if ( is_active_sidebar( 'footer-row-1-full' ) 
        || is_active_sidebar( 'footer-row-2-col-1' ) 
...
<div class="footer-widgets">
    ...
    <!-- Footer Row 1 -->
    <?php if(is_active_sidebar( 'footer-row-1-full' )) { ?>
    <div class="footer-row-1-full"><?php dynamic_sidebar('footer-row-1-full'); ?></div><hr />
    <?php } ?>
    <!-- /Footer Row 1 -->
